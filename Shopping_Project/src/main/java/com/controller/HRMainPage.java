...
@WebServlet("/HRSystemMainPage.do")
public class HRMainPage extends HttpServlet {
	...
	private void processAction(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("------------------------"+emps.hasNext());
		while(emps.hasNext()) {
			Employee emp = emps.next();
			System.out.println(emp.getLastName()+"<br>");
		}
		

		request.getRequestDispatcher("/HRsystemMainPage1.jsp").forward(request, response);
		out.close();
